---
name: openprd-experience-diagnostic-candidate-eval-20260606232925
description: OpenPrd 在本轮回顾时自动生成的待确认项目经验草案。
---

# openprd-experience-diagnostic-candidate-eval-20260606232925

> 状态：draft
> 候选目录：`.openprd/knowledge/candidates/candidate-eval-20260606232925`
> Promote：`openprd quality . --learn --from .openprd/knowledge/candidates/candidate-eval-20260606232925`
...
- 任务场景: dev-check
- 相关文件: src/workspace-core.js、src/workspace-workflow.js、src/codex-hook-runner-template.mjs、src/agent-integration.js、skills/openprd-harness/SKILL.md、test/requirement-gate.test.js
...
- 项目经验候选与诊断包
- 待确认的项目经验草案
- 验证结论: dev-check attention=1, warning=5
- 可复用的验证链路与收尾动作
