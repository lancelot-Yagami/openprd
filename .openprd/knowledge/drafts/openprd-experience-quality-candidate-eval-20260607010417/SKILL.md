---
name: openprd-experience-quality-candidate-eval-20260607010417
description: OpenPrd 在本轮回顾时自动生成的待确认项目经验草案。
---

# openprd-experience-quality-candidate-eval-20260607010417

> 状态：draft
> 候选目录：`.openprd/knowledge/candidates/candidate-eval-20260607010417`
> Promote：`openprd quality . --learn --from .openprd/knowledge/candidates/candidate-eval-20260607010417`
...
- dev-check: dev-check attention=1, warning=5 | touched: src/workspace-core.js, src/workspace-workflow.js, src/codex-hook-runner-template.mjs, src/agent-integration.js, skills/openprd-harness/SKILL.md, test/requirement-gate.test.js
- dev-check: dev-check attention=1, warning=2 | touched: src/codex-hook-runner-template.mjs, src/cli/run-print.js, src/agent-integration.js, skills/openprd-harness/SKILL.md, test/requirement-gate.test.js
...
- `.openprd/quality/reports/eval-20260607010417.json`
...
- dev-check attention=1, warning=5
