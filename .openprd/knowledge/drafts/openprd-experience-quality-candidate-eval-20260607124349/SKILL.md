---
name: openprd-experience-quality-candidate-eval-20260607124349
description: OpenPrd 在本轮回顾时自动生成的待确认项目经验草案。
---

# openprd-experience-quality-candidate-eval-20260607124349
...
- dev-check: dev-check attention=1, warning=2 | touched: src/agent-integration.js, src/codex-hook-runner-template.mjs, test/openprd-agent-integration.test.js
...
- `.openprd/quality/reports/eval-20260607124349.json`
